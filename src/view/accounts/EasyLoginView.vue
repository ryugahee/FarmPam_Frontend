...
<div class="easyLoginForm">
  ...
  <input type="text" class="txt-input" id="itemname" value="dust">
</div>
...
<div class="easyLoginForm">
  ...
  <input type="text" class="txt-input" id="itemnew" value="">
</div>

<div class="easyLoginForm">
  <label for="itemnew"><span>* </span>지역</label>
  <input type="text" class="txt-input" id="itemnew" value="">
</div>
...
<style scoped>
@import "../../../public/assets/css/easyLogin.css";
</style>